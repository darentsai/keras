...
@keras_export("keras.layers.MultiHeadAttentionRBF")
class MultiHeadAttentionRBF(Layer):
    ...
    def _compute_attention(
        ...
        if rbf:
            ...
            key_2norm = ops.multiply(
                key_2norm, ops.cast(self._inverse_sqrt_key_dim * 0.5, key_2norm.dtype)
            )
    ...
    def call(
        ...
        # Delete the masks because the masks are handled at the level of the layer
